...
public class CreateAddAppDialog extends Dialog {
    Activity context;

    private Button btn_save;

    public EditText text_name;
    public EditText text_power;
    public EditText text_type;
    public String name;
    public float power;
    ...
    public CreateAddAppDialog(Activity context, int theme, View.OnClickListener clickListener) {
        super(context, theme);
        this.context = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 指定布局
        this.setContentView(R.layout.add_appliance);
